...
public class actabout extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "ir.safhebeshkan.apkkala", "ir.safhebeshkan.apkkala.actabout");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "ir.safhebeshkan.apkkala", "ir.safhebeshkan.apkkala.actabout");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "ir.safhebeshkan.apkkala.actabout", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
String[] _types = null;
 ...
 //BA.debugLineNum = 21;BA.debugLine="Activity.LoadLayout(\"frmabout\")";
mostCurrent._activity.LoadLayout("frmabout",mostCurrent.activityBA);
 //BA.debugLineNum = 22;BA.debugLine="pnl1.Color = Colors.RGB(229,226,226)";
mostCurrent._pnl1.setColor(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (229),(int) (226),(int) (226)));
 //BA.debugLineNum = 23;BA.debugLine="Panel1.Color = Colors.RGB(229,226,226)";
mostCurrent._panel1.setColor(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (229),(int) (226),(int) (226)));
 //BA.debugLineNum = 24;BA.debugLine="lbl1.Typeface = Typeface.LoadFromAssets(\"SROYA.TTF";
mostCurrent._lbl1.setTypeface(anywheresoftware.b4a.keywords.Common.Typeface.LoadFromAssets("SROYA.TTF"));
 //BA.debugLineNum = 25;BA.debugLine="Label1.Typeface = Typeface.LoadFromAssets(\"SROYA.T";
mostCurrent._label1.setTypeface(anywheresoftware.b4a.keywords.Common.Typeface.LoadFromAssets("SROYA.TTF"));
 //BA.debugLineNum = 26;BA.debugLine="Dim verticalPosition As String = \"bottom\" '\"top\"";
_verticalposition = "bottom";
 //BA.debugLineNum = 27;BA.debugLine="Dim horizontalPosition As String = \"center\" '\"";
_horizontalposition = "center";
 //BA.debugLineNum = 28;BA.debugLine="Dim r As Reflector";
_r = new anywheresoftware.b4a.agraham.reflection.Reflection();
 //BA.debugLineNum = 29;BA.debugLine="Dim args(3) As Object = Array As Object(r.GetA";
_args = new Object[]{(Object)(_r.GetActivity(processBA)),(Object)(_verticalposition),(Object)(_horizontalposition)};
 //BA.debugLineNum = 30;BA.debugLine="Dim types(3) As String = Array As String(\"andr";
...
public static String  _btnback_click() throws Exception{
 //BA.debugLineNum = 42;BA.debugLine="Sub btnback_Click";
...
public static String  _globals() throws Exception{
 ...
 //BA.debugLineNum = 11;BA.debugLine="Private lbl1 As Label";
...
mostCurrent._panel1 = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 14;BA.debugLine="Private pnl1 As Panel";
